...
interface ContractDetails {
    ...
    readonly deploymentCalldata?: Uint8Array;
...
interface RustContractBinding {
    readonly id: bigint;
    readonly load: (data: Uint8Array) => Promise<Uint8Array>;
    readonly store: (data: Uint8Array) => Promise<Uint8Array>;
    readonly tLoad: (data: Uint8Array) => Promise<Uint8Array>;
    readonly tStore: (data: Uint8Array) => Promise<Uint8Array>;
    readonly call: (data: Uint8Array) => Promise<Uint8Array>;
    readonly deployContractAtAddress: (data: Uint8Array) => Promise<Uint8Array>;
    readonly updateFromAddress: (data: Uint8Array) => Promise<Uint8Array>;
    readonly loadMLDSA: (data: Uint8Array) => Promise<Uint8Array>;
    readonly log: (data: Uint8Array) => void;
    readonly emit: (data: Uint8Array) => void;
    readonly inputs: () => Promise<Uint8Array>;
