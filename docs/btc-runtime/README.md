...
#### [OP20S - Stablecoin / Pegged-Token Base](./contracts/op20s-stablecoin.md)
- [Overview](./contracts/op20s-stablecoin.md#overview)
- [How Peg Rates Work](./contracts/op20s-stablecoin.md#how-peg-rates-work)
  - [Staleness Model](./contracts/op20s-stablecoin.md#staleness-model)
- [Peg Update Flow](./contracts/op20s-stablecoin.md#peg-update-flow)
- [Peg Authority Transfer](./contracts/op20s-stablecoin.md#peg-authority-transfer)
- [Initialization](./contracts/op20s-stablecoin.md#initialization)
- [Public Methods](./contracts/op20s-stablecoin.md#public-methods)
  - [Read-Only (Constant) Methods](./contracts/op20s-stablecoin.md#read-only-constant-methods)
  - [State-Changing Methods](./contracts/op20s-stablecoin.md#state-changing-methods)
  - [Inherited from OP20](./contracts/op20s-stablecoin.md#inherited-from-op20)
- [Events](./contracts/op20s-stablecoin.md#events)
- [Protected Methods](./contracts/op20s-stablecoin.md#protected-methods)
- [Storage Layout](./contracts/op20s-stablecoin.md#storage-layout)
- [Example: Full Stablecoin Contract](./contracts/op20s-stablecoin.md#example-full-stablecoin-contract)
- [Security Considerations](./contracts/op20s-stablecoin.md#security-considerations)
  - [Peg Authority Compromise](./contracts/op20s-stablecoin.md#peg-authority-compromise)
  - [Staleness Risks](./contracts/op20s-stablecoin.md#staleness-risks)
  - [Authority Renunciation](./contracts/op20s-stablecoin.md#authority-renunciation)
  - [Rate Manipulation](./contracts/op20s-stablecoin.md#rate-manipulation)
- [Comparison with Ethereum Stablecoins](./contracts/op20s-stablecoin.md#comparison-with-ethereum-stablecoins)
