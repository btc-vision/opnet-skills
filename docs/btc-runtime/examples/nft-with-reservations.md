...
sequenceDiagram
    ...
    Admin->>BTC: Submit startReservation(144) TX
    BTC->>Contract: Execute startReservation
    Contract->>Storage: Write reservationEnd = currentBlock + 144 blocks
    ...
    Contract->>Contract: Check currentBlock < reservationEnd
