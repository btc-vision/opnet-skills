...
// Address.fromString() takes TWO hex params, NOT a bech32 address string
const address = Address.fromString(hashedMLDSAKey, tweakedPublicKey);
...
enum AddressTypes {
    ...
    P2WDA = 'P2WDA',                             // Witness Data Anchoring
}
```
